      ...
      <main className="flex-1">
        ...
        <section className="py-8 px-4 md:px-8 lg:px-16 max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-start">
            ...
            {/* Location Info */}
            <div className="w-full lg:w-1/2">
              <h2 className="text-3xl md:text-4xl font-bold text-teal-600 mb-4">{pageContent.locationTitle}</h2>
              <p className="text-gray-700 leading-relaxed mb-6">
        ...
        <section className="py-8 pb-16 px-4 md:px-8 lg:px-16 max-w-7xl mx-auto">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-teal-600 mb-6">{pageContent.faqTitle}</h2>
