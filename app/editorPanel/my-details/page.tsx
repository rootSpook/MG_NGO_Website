      ...
      <div className="mx-auto max-w-[1180px]">
        ...
        <section className="mt-7 rounded-[24px] bg-[#e8e8e8] p-6 shadow-md">
          ...
          <p className="text-[15px] leading-7 text-[#444]">
            Bu panel şu anda functional frontend demo amacıyla hazırlanmıştır.
            Bazı işlemler mock veri ile çalışmaktadır. Kalıcı veri yönetimi ve
            dosya saklama işlemleri backend entegrasyonu tamamlandığında gerçek
            sistemle bağlantılı hale getirilecektir.
          </p>
        </section>
      </div>
    </EditorShell>
