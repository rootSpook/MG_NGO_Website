...
export default function MyDetailsPage() {
  ...
  function handlePhotoChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    setTimeout(() => setPreviewShown(false), 3000);
  }
    ...
    <EditorShell>
      <div className="mx-auto max-w-2xl">
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-gray-500">Profil bilgilerinizi buradan yönetebilirsiniz.</p>
        </div>

        <div className="space-y-6">
          {/* Profile Photo */}
          <div className="rounded-xl border border-gray-200 bg-white p-6">
            <h2 className="mb-4 text-base font-semibold text-gray-800">Profil Fotoğrafı</h2>
            <div className="flex items-center gap-6">
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute -bottom-1 -right-1 flex h-7 w-7 items-center justify-center rounded-full bg-primary text-white shadow-md hover:bg-primary/90"
                >
              ...
              <div>
                ...
                <p className="mt-1.5 text-xs text-gray-400">PNG, JPG veya WEBP. Maks. 5 MB.</p>
                {previewShown && (
                  <p className="mt-1.5 flex items-center gap-1 text-xs text-green-600">
                    <CheckCircle2 className="h-3.5 w-3.5" /> Önizleme güncellendi
                  </p>
                )}
              </div>
            </div>
          ...
          {/* Account Info */}
          <div className="rounded-xl border border-gray-200 bg-white p-6">
            <h2 className="mb-4 text-base font-semibold text-gray-800">Hesap Bilgileri</h2>
            <div className="space-y-4">
              ...
              <div>
                <label className="mb-1.5 block text-sm font-medium text-gray-700">Kullanıcı ID</label>
